    ...
    <section className="section-padding pt-32 pb-16 md:pt-40">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          ...
          Ikamba Impakt produces documentaries, video stories, and photography that communicate real impact. Our work focuses on capturing authentic stories that inspire action and build trust.
        </motion.p>
