    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="max-w-5xl mx-auto">
          ...
          >
            Communication & Production Systems Partner
          </motion.p>
          <motion.h1
          ...
          >
            We help communication and marketing teams plan, produce, track, and archive content through a structured production system.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {problems.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i + 2}
                className="bg-surface-elevated rounded-lg p-6 border border-border flex gap-4"
              >
                <item.icon className="text-danger shrink-0 mt-0.5" size={20} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i + 2}
                className="relative bg-surface-elevated rounded-lg p-6 border border-border group hover:border-accent transition-colors"
              >
                <div className="w-10 h-10 rounded-md gradient-gold flex items-center justify-center mb-4">
                ...
                <h3 className="text-base font-bold mt-1 mb-2">{step.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {solutions.map((s, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i + 2}
                className="bg-surface-elevated border border-border rounded-lg p-6 hover:shadow-md transition-shadow"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-lg font-bold mt-2 mb-2">{c.client}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i + 2}
                className="bg-surface-elevated border border-border rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer"
              >
                <span className="text-[10px] uppercase tracking-widest text-accent font-semibold">{a.category}</span>
                <h3 className="text-base font-bold mt-2 leading-snug">{a.title}</h3>
              </motion.div>
            ))}
          </div>
        </div>
