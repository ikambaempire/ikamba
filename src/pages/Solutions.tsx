  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="relative h-56 md:h-72 overflow-hidden gradient-brand">
      ...
      <div className="absolute inset-0 flex items-center justify-between max-w-6xl mx-auto px-4 sm:px-6 lg:px-10">
        <p className="text-white text-xl md:text-2xl font-bold max-w-lg relative z-10">Real advisors. Real results. Real businesses across Rwanda.</p>
        <div className="hidden md:flex items-center gap-6 relative z-10">
          {[Calculator, BookOpen, Building2, FileCheck].map((Icon, i) => (
            <motion.div key={i}
